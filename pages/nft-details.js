...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-base minlg:text-xl">{nft.price}total</p>
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">{nft.price}<span className="font-semibold"> {nftCurrency}</span></p>
    </div>
  </div>
);
        ...
        <Modal
          ...
          body={(
            <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
              ...
              <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl mt-10">Success buying <span className="font-semibold"> {nft.name} from {shortenAddress(nft.seller)}</span></p>
            </div>
          )}
          footer={(
